                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>the action or process of talking about something in order to reach a decision or to exchange ideas.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>the process whereby each party to a case sorts through and analyzes the documents and data they possess.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>To acquire means to get or come to own something. You acquire an education by your own effort. You acquire a painting by paying for it</p>
                        </div>
                    </div>
                </div>
            </div>
